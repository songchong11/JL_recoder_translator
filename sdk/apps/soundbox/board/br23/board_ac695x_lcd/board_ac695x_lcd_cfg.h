#ifndef CONFIG_BOARD_AC695X_LCD_CFG_H
#define CONFIG_BOARD_AC695X_LCD_CFG_H
...
#define TCFG_UART0_TX_PORT  				IO_PORTA_02                            //串口发送脚配置
...
#define TCFG_HW_SPI0_BAUD		48000000L
...
#define TCFG_ADKEY_AD2      (0x3ffL * 150  / (150  + R_UP))     //9.1k
#define TCFG_ADKEY_AD3      (0x3ffL * 330 / (330 + R_UP))     //15k
#define TCFG_ADKEY_AD4      (0x3ffL * 1000 / (1000  + R_UP))     //24k
#define TCFG_ADKEY_AD5      (0x3ffL)// * 510  / (510  + R_UP))     //51k
#define TCFG_ADKEY_AD6      (0x3ffL)// * 510  / (510  + R_UP))     //51k
...
#else
#define TCFG_LINEIN_LR_CH					AUDIO_LIN0_LR//AUDIO_LIN0R_CH
...
#error "TCFG_SPI_LCD_ENABLE and TCFG_SIMPLE_LCD_ENABLE, please close one !!!"
#endif //(TCFG_SPI_LCD_ENABLE &&  TCFG_SIMPLE_LCD_ENABLE)
