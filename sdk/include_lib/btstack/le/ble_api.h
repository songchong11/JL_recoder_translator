...
/**********************************************************************************
   ...
   @function   ble master&slave 配置配对表(可以不设置,使用sdk默认值)
...
/**********************************************************************************
   ...
   @return    true or false
	note:VM 掉电记录保护
	note:是否覆盖是由接口 ble_list_config_reset 的参数 is_allow_cover 决定
 *********************************************************************************/
...
/**********************************************************************************
   ...
   @function   ble 获取配对表中最后连接设备的 id_address (public address)
   @param [out] id_addr
   @param [in]
   @param [in]
   @return    true or false
...
/**********************************************************************************
   ...
   @function   ble 获取已配对设备连接地址对应的 id_address (public address)
   @param [in] conn_addr        对方连接地址6bytes
   @param [in] conn_addr_type   对方连接地址类型range: 0~1
   @param [out] id_addr
   @param [in]
